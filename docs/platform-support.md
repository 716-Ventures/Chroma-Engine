...
| Linux x86-64 / ARM64 | Supported | H.264 decode/encode; HEVC Main/Main10 decode; AV1 decode via dav1d | Safe Rust scalar backend | VA-API device/profile probing; decode execution pending. NVENC/NVDEC and QSV modeled | H.264/HEVC/AV1 with copy-compatible audio or TrueHD-to-AAC; DTS decode remains a gap |
| Linux-based NAS x86-64 / ARM64 | Supported under the Linux contract | H.264 decode/encode; HEVC Main/Main10 decode; AV1 decode via dav1d | Safe Rust scalar backend | VA-API device/profile probing when render nodes and a driver are exposed; decode execution pending | H.264/HEVC/AV1 with copy-compatible audio or TrueHD-to-AAC; DTS decode remains a gap |
