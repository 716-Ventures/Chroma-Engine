...
| --- | --- | --- | --- | --- | --- |
| macOS x86-64 / ARM64 | Supported | H.264 decode/encode; HEVC Main/Main10 decode | Safe Rust fallback; AudioToolbox preferred | VideoToolbox executable | H.264/HEVC with copy-compatible audio or TrueHD-to-AAC |
| Windows x86-64 / ARM64 | Supported | H.264 decode/encode; HEVC Main/Main10 decode | Safe Rust scalar backend | NVENC, QSV, AMF, and DirectX adapters modeled, not executable | H.264/HEVC with copy-compatible audio or TrueHD-to-AAC; DTS decode remains a gap |
| Linux x86-64 / ARM64 | Supported | H.264 decode/encode; HEVC Main/Main10 decode | Safe Rust scalar backend | VA-API, NVENC/NVDEC, and QSV adapters modeled, not executable | H.264/HEVC with copy-compatible audio or TrueHD-to-AAC; DTS decode remains a gap |
| Linux-based NAS x86-64 / ARM64 | Supported under the Linux contract | H.264 decode/encode; HEVC Main/Main10 decode | Safe Rust scalar backend | Depends on a future adapter and exposed device/runtime | H.264/HEVC with copy-compatible audio or TrueHD-to-AAC; DTS decode remains a gap |
