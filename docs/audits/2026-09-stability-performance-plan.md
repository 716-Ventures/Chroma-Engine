...
Impact: late resumes incur avoidable reads and CPU work; sequential playback repeats prefix scans. This is a code-level explanation for potential slow resumes, not a measured attribution of the earlier Aquaman incident.
