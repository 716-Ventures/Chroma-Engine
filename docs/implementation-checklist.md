...
- [x] Extend retained fMP4 transcoding to MP4/MOV sources. Validated a two-segment H.264/AAC
  MP4 window with one source/index pass, one retained H.264 decoder/encoder pair, and copied AAC.
