...
- [ ] Linux executable VAAPI/NVENC/QSV path. VA-API probing now dynamically opens render nodes and verifies H.264/HEVC VLD profiles; decoded-surface allocation and the executable decode/encode path remain.
