...
under its MIT license. It routes HEVC Main through the existing hardware-only Media Foundation
and D3D11 zero-copy path in addition to H.264. Chroma converts hvcC configuration and
length-prefixed HEVC samples to Annex-B before submission and performs checked texture readback.
